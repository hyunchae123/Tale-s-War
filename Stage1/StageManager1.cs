...
public class StageManager1 : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        Instantiate(player);
        PlayerMove.Instance.transform.position = new Vector3(6f, -10f, 0f);
        ...
        int[] remainTailsType = BringIntArry("Stage1Tailtype");
        float[] remainTailsPosX = BringFloatArry("Stage1TailX");
        float[] remainTailsPosY = BringFloatArry("Stage1TailY");
        ...
        PlayerPrefs.SetInt("PresentStageNum", 1);
    }
    ...
    private void Start()
    {
        ...
        if (existingTail[0] == true)
        {
            Instantiate(existingTailObject, new Vector3(5f, -5f, 0f), Quaternion.identity);
        }

        Instantiate(enemyPrefabs[0], new Vector3(0f, 0f, 0f), Quaternion.identity);
        Instantiate(enemyPrefabs[0], new Vector3(0f, 1f, 0f), Quaternion.identity);
        Instantiate(enemyPrefabs[0], new Vector3(11f, 0f, 0f), Quaternion.identity);
        Instantiate(enemyPrefabs[0], new Vector3(0f, -20f, 0f), Quaternion.identity);
        Instantiate(enemyPrefabs[0], new Vector3(11f, -20f, 0f), Quaternion.identity);
    }

    void Update()
    {
        if (PlayerMove.Instance.enemyCount == 5 && isWave2 == false)
        {
            waveNum = 2;
            isWave2 = true;
            ...
            Instantiate(enemyPrefabs[1], new Vector3(12f, 6f, 0f), Quaternion.identity);

        }
            

        if(PlayerMove.Instance.enemyCount == 10 && isWave3 == false)
        {
            waveNum = 3;
            isWave3 = true;
            ...
            Instantiate(enemyPrefabs[1], new Vector3(-2f, 6f, 0f), Quaternion.identity);
            Instantiate(enemyPrefabs[1], new Vector3(10f, 6f, 0f), Quaternion.identity);
            Instantiate(enemyPrefabs[1], new Vector3(-2f, -25f, 0f), Quaternion.identity);

            Instantiate(enemyPrefabs[2], new Vector3(6f, -10f, 0f), Quaternion.identity);
        }
            

        if (PlayerMove.Instance.enemyCount == 18)
        {
            myAudio.Stop();
            waveNum = 4;
            PlayerPrefs.SetInt("AbleStageLevel", 2);
            PlayerPrefs.Save();
        }
