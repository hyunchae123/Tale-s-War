...
public class StageManager3 : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        int[] remainTailsType = BringIntArry("Stage3Tailtype");
        float[] remainTailsPosX = BringFloatArry("Stage3TailX");
        float[] remainTailsPosY = BringFloatArry("Stage3TailY");
        ...
        PlayerPrefs.SetInt("PresentStageNum", 3);
    }
    ...
    private void Start()
    {
        ...
        Instantiate(enemyPrefabs[1], new Vector3(25f, 5f, 0f), Quaternion.identity);
    ...
    void Update()
    {
        ...
        if (PlayerMove.Instance.enemyCount == 22 && isWave3 == false)
        {
            waveNum = 3;
            isWave3 = true;
            ...
            Instantiate(enemyPrefabs[0], new Vector3(18f, -10f, 0f), Quaternion.identity);
            Instantiate(enemyPrefabs[0], new Vector3(5f, -40f, 0f), Quaternion.identity);
            Instantiate(enemyPrefabs[0], new Vector3(7f, -40f, 0f), Quaternion.identity);
            ...
            Instantiate(enemyPrefabs[1], new Vector3(23f, -45f, 0f), Quaternion.identity);
            Instantiate(enemyPrefabs[1], new Vector3(0f, 5f, 0f), Quaternion.identity);
            Instantiate(enemyPrefabs[1], new Vector3(21f, 5f, 0f), Quaternion.identity);
        ...
        if (PlayerMove.Instance.enemyCount == 39)
        {
            myAudio.Stop();
            waveNum = 4;
            PlayerPrefs.SetInt("AbleStageLevel", 4);
            PlayerPrefs.Save();
        }
